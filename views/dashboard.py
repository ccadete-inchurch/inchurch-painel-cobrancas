...
def _render_dashboard(store, clientes, role):
    ...
    st.markdown(
        f'<div style="font-family:-apple-system,BlinkMacSystemFont,sans-serif;font-size:44px;font-weight:700;color:#e8eaf0;margin-top:32px;margin-bottom:48px;letter-spacing:-1.5px;line-height:1.1">Bem-vindo(a), {nome}!</div>',
