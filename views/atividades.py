...
def _render_atividades(store, clientes, role):
    ...
    _h_msg  = '<svg width="13" height="13" viewBox="0 0 24 24" fill="#5fa3ff" style="vertical-align:middle;margin-right:5px"><path d="M21 6.5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h11l4 4V6.5z"/></svg>'
